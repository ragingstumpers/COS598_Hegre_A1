...
class CurrentEthnicDominanceProjectionTimesPreviousLogsMinorConflictByCountryResolver(ResolverBase[dict[str, float]]):

    variable = VariableEnum.current_ethnic_dominance_projection_times_previous_logs_minor_conflict_by_country
