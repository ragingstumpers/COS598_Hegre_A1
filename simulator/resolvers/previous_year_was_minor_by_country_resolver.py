...
class PreviousYearWasMinorByCountryResolver(ResolverBase[dict[str, int]]):

    variable = VariableEnum.previous_year_was_minor_by_country
    ...
    def resolve(cls, current_values: dict[VariableEnum, Any]) -> dict[str, int]:
        ...
        return {
            ...
            for country, level in prev_conflict_level_by_country.values()
        }
