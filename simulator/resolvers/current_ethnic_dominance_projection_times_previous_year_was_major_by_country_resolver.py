...
class CurrentEthnicDominanceProjectionTimesPreviousYearWasMajorByCountryResolver(ResolverBase[dict[str, float]]):

    variable = VariableEnum.current_ethnic_dominance_projection_times_previous_year_was_major_by_country
