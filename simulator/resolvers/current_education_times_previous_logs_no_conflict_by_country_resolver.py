...
class CurrentEducationTimesPreviousLogsNoConflictByCountryResolver(ResolverBase[dict[str, float]]):

    variable = VariableEnum.current_education_times_previous_logs_no_conflict_by_country
