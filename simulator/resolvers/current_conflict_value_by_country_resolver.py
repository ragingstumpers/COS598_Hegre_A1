...
class CurrentConflictValueByCountryResolver(ResolverBase[dict[str, float]]):

    variable = VariableEnum.current_conflict_value_by_country
    dependencies = [
