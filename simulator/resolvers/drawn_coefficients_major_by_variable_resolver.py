...
class DrawnCoefficientsMajorByVariableResolver(ResolverBase[dict[str, float]]):

    variable = VariableEnum.drawn_coefficients_major_by_variable
    dependencies = [VariableEnum.average_coefficients_major_by_variable, VariableEnum.covariance_matrix_major_by_variable]
